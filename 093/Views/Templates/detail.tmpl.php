                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-7 d-flex flex-column">
                        ...
                        <div class="position-relative card-body border-0">
                            ...
                            <p id="derniereEnchere" class="badge text-bg-danger bg-gradient fs-5">
                        ...
                        <div class="card-footer border-0 d-flex justify-content-end gap-2">
                            <a href="/" class="btn btn-danger">Retour aux annonces</a>
                            <?php if(isset($_SESSION['username'])) { ?>
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#enchereModal">
                                    Enchérir
                                </button>
                            <?php } else { ?>
                                <a href="/?display=login&redirect=<?= $uid_annonce; ?>" class="btn btn-warning">Se connecter et placer une enchère</a>
                            <?php } ?>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content text-bg-dark bg-gradient" data-bs-theme="dark">
                ...
                <div class="modal-body border-0">
                    <div class="input-group">
                        ...
                        <span class="input-group-text bg-gradient">Montant de l'enchère :</span>
                        <input id="inputMontant" data-minenchere="<?= $minEnchere; ?>" type="number" class="form-control bg-gradient" name="montant" value="<?= $minEnchere; ?>" min="<?= $minEnchere; ?>" aria-label="Montant">
                ...
                <div class="modal-footer border-0">
                    ...
                    <button id="enchereSubmit" type="button" class="btn btn-warning">Placer enchère</button>
                </div>
            </div>
        </form>
    </div>
